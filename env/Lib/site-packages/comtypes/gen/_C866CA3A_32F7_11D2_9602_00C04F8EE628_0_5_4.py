...
__all__ = [
    ...
    'DISPID_SRRTOffsetFromStart', 'SpeechStreamFileMode',
    'DISPID_SPELexicalForm', 'DISPID_SOTCDefault',
    'SAFTADPCM_22kHzMono', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SBSRead', 'DISPID_SVEWord', 'DISPID_SDKOpenKey',
    'DISPID_SOTGetDescription', 'SpeechTokenShellFolder',
    'DISPID_SRGState', 'SPEI_TTS_PRIVATE', 'SPAUDIOSTATE', 'SVP_5',
    'DISPID_SPEEngineConfidence', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SFSClose', 'ISpeechPhraseRule',
    'SpeechGrammarTagUnlimitedDictation', 'SASPause', 'SPPS_Unknown',
    'DISPID_SRStatus', 'SPBO_PAUSE', 'ISpeechLexicon',
    'DISPID_SABIMinNotification', 'DISPID_SRSetPropertyNumber',
    'eLEXTYPE_PRIVATE10', 'SAFT16kHz8BitStereo', 'SRSActiveAlways',
    'DISPID_SOTMatchesAttributes', 'eLEXTYPE_PRIVATE11',
    'SPPS_NotOverriden', 'DISPID_SRCESoundEnd',
    'SpeechRecoContextState', 'SPPS_Modifier', 'eLEXTYPE_PRIVATE9',
    'SSTTTextBuffer', 'SVPNormal', 'DISPID_SABufferInfo', 'SVP_17',
    'SSSPTRelativeToStart', 'ISpObjectTokenCategory',
    'SPWORDPRONUNCIATIONLIST', 'SPINTERFERENCE_LATENCY_WARNING',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SOTGetAttribute',
    'ISpStreamFormat', 'DISPID_SVRate', 'DISPID_SPRuleParent',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SDKDeleteKey',
    'SGRSTTDictation', 'SPSHORTCUTTYPE', 'SWTAdded',
    'SAFT32kHz16BitMono', 'DISPID_SDKCreateKey', 'SP_VISEME_11',
    'DISPID_SRGCmdLoadFromFile', 'SAFTTrueSpeech_8kHz1BitMono',
    'SAFTText', 'SPTEXTSELECTIONINFO', 'DISPID_SRGReset',
    'SRERecognition', 'SPVPRI_ALERT', 'SP_VISEME_17',
    'SDTPronunciation', 'STSF_AppData', 'SGSDisabled',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'ISpVoice',
    'DISPID_SRGRules', 'DISPID_SRCRecognizer', 'SSSPTRelativeToEnd',
    'SVP_11', 'SpeechSpecialTransitionType', 'eLEXTYPE_RESERVED7',
    'DISPID_SPPFirstElement', 'SPAO_RETAIN_AUDIO', 'ISpRecoGrammar',
    'DISPIDSPTSI_ActiveOffset', 'SAFTCCITT_ALaw_44kHzMono',
    'SVEEndInputStream', 'STCLocalServer', 'ISpeechPhraseElement',
    'SAFTCCITT_uLaw_11kHzStereo', 'SDTLexicalForm',
    'SGPronounciation', 'SSFMCreateForWrite', 'DISPID_SGRSTType',
    'SPPS_LMA', 'SVEAudioLevel', 'SP_VISEME_1', 'ISpeechCustomStream',
    'SpeechWordPronounceable', 'SVEViseme', 'SRERecoOtherContext',
    'SRAImport', 'SPSMF_SAPI_PROPERTIES', 'ISpeechLexiconWord',
    'DISPID_SVAudioOutput', 'SpeechFormatType',
    'DISPID_SGRsCommitAndSave', 'SLOStatic',
    'DISPID_SRCreateRecoContext', 'DISPIDSPTSI_SelectionOffset',
    'SPAS_STOP', 'SPEI_PHONEME', 'ISpeechAudioStatus',
    'DISPID_SGRsDynamic', 'SpMMAudioOut', 'Speech_StreamPos_Asap',
    'DISPID_SVSInputSentenceLength', 'DISPID_SFSOpen',
    'ISpeechRecoResultDispatch', 'SDKLCurrentConfig',
    'DISPID_SADefaultFormat', 'SPAUDIOBUFFERINFO', 'SGRSTTWord',
    'SINoise', 'SpNullPhoneConverter', 'DISPID_SDKEnumValues',
    'DISPID_SABufferNotifySize', 'SP_VISEME_15', 'DISPID_SPPName',
    'DISPID_SPRules_NewEnum', 'eWORDTYPE_DELETED',
    'DISPID_SRGSetWordSequenceData', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SPEsCount', 'SLTUser', 'SASStop', 'DISPID_SCSBaseStream',
    'DISPID_SMSALineId', 'SPAS_CLOSED', 'ISpPhoneConverter',
    'SRADynamic', 'SFTInput', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SPIProperties', 'DISPID_SVStatus', 'SpInProcRecoContext',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SLWWord', 'SPAR_Low', 'DISPID_SRSetPropertyString',
    'DISPID_SVGetAudioOutputs', '_ISpeechRecoContextEvents',
    'SDTDisplayText', 'SpWaveFormatEx', 'SP_VISEME_16',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SpeechAudioFormat',
    'SPSLMA', 'SPINTERFERENCE', 'eLEXTYPE_USER',
    'DISPID_SpeechPhraseBuilder', 'SVSFIsXML', 'SECHighConfidence',
    'SPGS_DISABLED', 'IEnumSpObjectTokens', 'DISPID_SRCESoundStart',
    'DISPIDSPTSI_ActiveLength', 'SPPS_SuppressWord', 'SPSNoun',
    'DISPID_SPANumberOfElementsInResult', 'SpeechLoadOption',
    'SPEI_RESERVED2', 'SPEI_SR_PRIVATE', 'DISPID_SPIAudioSizeTime',
    'DISPID_SPEDisplayText', 'SREBookmark', 'DISPID_SPPsCount',
    'SPEI_VOICE_CHANGE', 'DISPID_SLPsItem', 'SGSExclusive',
    'SPWT_DISPLAY', 'DISPID_SPIRetainedSizeBytes', 'DISPID_SPPParent',
    'SP_VISEME_12', 'SPEI_MAX_SR', 'DISPID_SBSFormat',
    'SPDKL_CurrentUser', 'DISPID_SPIElements', 'DISPID_SPPConfidence',
    'SVPOver', 'eLEXTYPE_PRIVATE8', 'DISPID_SPRuleConfidence',
    ...
    'SAFTCCITT_uLaw_8kHzMono', 'STCAll', 'SAFT22kHz16BitMono',
    'SpeechAllElements', 'SPWORDLIST', 'DISPID_SpeechRecognizer',
    'SpeechPropertyAdaptationOn', 'SPEI_VISEME',
    'DISPID_SGRAddResource', 'SpeechVoiceSpeakFlags', 'IEnumString',
    ...
    'DISPID_SGRsCount', 'DISPID_SRRTStreamTime', 'SVF_Emphasis',
    'SpeechRecoProfileProperties', 'SAFT22kHz16BitStereo',
    'DISPID_SPAsItem', 'DISPID_SVPause', 'DISPID_SGRSTRule',
    'SPAR_Medium', 'DISPID_SVSRunningState', 'DISPID_SPIRule',
    'SP_VISEME_2', 'SAFT48kHz8BitMono', 'ISpEventSource',
    ...
    'DISPID_SpeechGrammarRuleStateTransition', 'SpeechVoicePriority',
    'ISpeechPhraseReplacements', 'SSFMCreate', 'SPPARTOFSPEECH',
    'SAFTADPCM_11kHzStereo', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SpeechVoice', 'DISPID_SABIEventBias',
    'DISPID_SVSInputWordPosition', 'SpMemoryStream', 'SINone',
    'SRSEIsSpeaking', 'SVP_7', 'SPEI_WORD_BOUNDARY',
    'SPEI_SR_BOOKMARK', 'DISPID_SVEVoiceChange', 'DISPID_SOTCategory',
    'SPEI_PHRASE_START', 'SPEI_SR_AUDIO_LEVEL',
    'SpeechAudioProperties', 'ISpeechMemoryStream', 'DISPID_SGRSRule',
    'SpeechMicTraining', 'SPSHT_NotOverriden',
    'Speech_StreamPos_RealTime', 'SPSInterjection',
    'SAFT44kHz8BitMono', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPINTERFERENCE_NONE', 'SVSFIsNotXML', 'DISPID_SPIAudioSizeBytes',
    'SpeechAudioFormatGUIDWave', 'DISPID_SDKGetBinaryValue',
    'SAFT44kHz16BitStereo', '_ISpeechVoiceEvents', 'DISPID_SGRsItem',
    'STSF_CommonAppData', 'SRSInactive', 'SpPhraseInfoBuilder',
    'DISPID_SVEStreamEnd', 'DISPID_SPRs_NewEnum',
    'DISPID_SRGDictationLoad', 'ISpeechTextSelectionInformation',
    'DISPID_SVSkip', 'SpeechEmulationCompareFlags', 'UINT_PTR',
    'DISPID_SpeechLexicon', 'SGDisplay',
    'DISPID_SLGetGenerationChange', 'DISPID_SOTDataKey',
    'SAFT32kHz16BitStereo', 'SECFEmulateResult', 'ISpeechObjectToken',
    'SECFIgnoreKanaType', 'SP_VISEME_14', 'SAFT16kHz8BitMono',
    'SPSHORTCUTPAIRLIST', 'DISPID_SpeechObjectTokenCategory',
    'SPDATAKEYLOCATION', 'SRERequestUI', 'SpVoice', 'ISpRecoContext',
    'SPBINARYGRAMMAR', 'SP_VISEME_21', 'DISPID_SDKDeleteValue',
    'SpeechPartOfSpeech', 'SVP_8', 'eLEXTYPE_PRIVATE18',
    'SRTSMLTimeout', 'SAFT12kHz8BitMono', 'SAFT8kHz8BitMono',
    'ISpRecognizer', 'DISPID_SRCVoice', 'DISPID_SRCPause',
    'DISPID_SPPChildren', 'ISpEventSink', 'SRTReSent',
    'DISPID_SpeechLexiconWords', 'SPSSuppressWord',
    'SREPropertyNumChange', 'SVP_1', 'SVP_12',
    'DISPID_SLGenerationId', 'DISPID_SRCResume',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SPERetainedSizeBytes',
    'SPPS_Noun', 'DISPID_SPRuleName', 'eLEXTYPE_PRIVATE1',
    'SpCompressedLexicon', 'DISPID_SOTCEnumerateTokens', 'SpLexicon',
    'DISPID_SRRGetXMLResult', 'ISpObjectToken',
    'DISPID_SVSLastStreamNumberQueued', 'SGDSActive', 'SpMMAudioEnum',
    'SPWORDPRONOUNCEABLE', 'SPDKL_DefaultLocation', 'SSTTWildcard',
    'SPDKL_CurrentConfig', 'SPVPRI_OVER', 'SpeechDiscardType',
    'SPBO_NONE', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SVEAudioLevel', 'SVPAlert', 'SPEI_MIN_SR',
    ...
    'SpeechCategoryRecognizers', 'SVF_Stressed', 'DISPID_SRCState',
    'SINoSignal', 'SBOPause', 'SAFT8kHz16BitStereo',
    'SPGRAMMARWORDTYPE', 'DISPID_SLWs_NewEnum',
    'SpTextSelectionInformation', 'ISpStreamFormatConverter',
    'SpSharedRecoContext', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SRCEHypothesis', 'SVP_3', 'SPPS_RESERVED3',
    'SpeechVisemeType', 'DISPID_SVSInputWordLength',
    'DISPID_SRCEAudioLevel', 'SAFTNoAssignedFormat', 'SRARoot',
    'SpInprocRecognizer', 'DISPID_SRCEAdaptation',
    'ISpeechRecognizerStatus', 'SITooLoud', 'ISpeechXMLRecoResult',
    'SAFT12kHz16BitStereo', 'SGDSInactive', 'DISPID_SPRulesCount',
    '_RemotableHandle', 'DISPID_SVSLastBookmark', 'ISpeechFileStream',
    'SpeechGrammarTagWildcard', 'DISPID_SRGDictationUnload',
    'DISPID_SpeechPhraseProperty', 'SAFTADPCM_8kHzMono',
    'DISPID_SGRSTPropertyName', 'SP_VISEME_19', 'SREInterference',
    'DISPID_SpeechDataKey', 'SGRSTTRule', 'SpeechVoiceEvents',
    'SAFTCCITT_ALaw_11kHzMono', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SGRsCommit', 'SPWT_LEXICAL', 'DISPID_SGRSTText',
    'SSFMOpenForRead', 'DISPID_SWFEFormatTag', 'ISpeechAudio',
    'DISPID_SRCSetAdaptationData', 'DISPID_SGRSTWeight', 'SVP_10',
    'SPLO_STATIC', 'SPWORDTYPE', 'DISPID_SpeechPhraseAlternate',
    'SpeechRetainedAudioOptions', 'SP_VISEME_5', 'ISpeechRecoResult2',
    'DISPID_SLGetWords', 'SVEAllEvents', 'ISpeechPhoneConverter',
    'DISPID_SGRSTransitions', 'SGDSActiveUserDelimited',
    'eLEXTYPE_MORPHOLOGY', 'SPPS_Function', 'SAFT12kHz16BitMono',
    'ISpRecoGrammar2', 'SGDSActiveWithAutoPause',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPWORD', 'ISpeechMMSysAudio',
    'SREAdaptation', 'DISPID_SRAudioInput', 'DISPID_SVSLastResult',
    'SVP_16', 'DISPID_SPERequiredConfidence', 'ISpRecoContext2',
    'SECFNoSpecialChars', 'SLODynamic', 'SAFT32kHz8BitStereo',
    'DISPID_SRSSupportedLanguages', 'SPEVENT',
    'DISPID_SRSAudioStatus', 'SpeechDictationTopicSpelling',
    'SPSMF_UPS', 'SpeechEngineProperties',
    'DISPID_SpeechPhoneConverter', 'DISPID_SGRName',
    'DISPID_SpeechLexiconWord', 'DISPID_SLWsItem', 'SVP_15',
    'DISPID_SPIReplacements',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPPHRASEREPLACEMENT', 'SPEI_END_INPUT_STREAM',
    'SDA_No_Trailing_Space', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SpeechPhraseRule', 'DISPID_SOTDisplayUI',
    'SPEI_RECO_STATE_CHANGE', 'SAFTCCITT_uLaw_8kHzStereo',
    'SpeechUserTraining', 'DISPID_SGRSTs_NewEnum', 'SPGRAMMARSTATE',
    'SAFTADPCM_44kHzMono',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpeechPhraseInfo', 'SPGS_EXCLUSIVE', 'SDKLDefaultLocation',
    'SPEI_RESERVED6', 'DISPID_SGRInitialState', 'DISPID_SVVolume',
    'SGLexical', 'DISPID_SPIGrammarId', 'SPLEXICONTYPE',
    'ISpPhraseAlt', 'SPEI_RESERVED3', 'ISpeechRecoResult',
    'SpeechRuleAttributes', 'SPRST_ACTIVE',
    'DISPID_SRGetPropertyNumber', 'DISPID_SAEventHandle',
    '_SPAUDIOSTATE', 'SpeechTokenIdUserLexicon', 'ISpAudio',
    'ISpGrammarBuilder', 'SPDKL_LocalMachine', 'eLEXTYPE_APP',
    'DISPID_SpeechAudio', 'SpeechCategoryRecoProfiles',
    'DISPID_SVWaitUntilDone', 'SPSHT_OTHER', 'SRAONone',
    'DISPID_SVEStreamStart', 'DISPID_SRIsShared', 'DISPID_SPPId',
    'SpCustomStream', 'SPEI_SOUND_START', 'IInternetSecurityMgrSite',
    'DISPIDSPRG', 'DISPID_SRCAudioInInterferenceStatus', 'SGSEnabled',
    'SVEPhoneme', 'SAFT16kHz16BitStereo', 'ISpeechPhraseReplacement',
    'ISpeechGrammarRules', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SRCS_Enabled', 'SPEI_RESERVED1', 'SRAInterpreter',
    'eLEXTYPE_RESERVED6', 'ISpDataKey', 'SVEVoiceChange',
    'SpeechRuleState', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SPCIdToPhone', 'STSF_LocalAppData', 'ISpeechVoice',
    'SRADefaultToActive', 'SRTEmulated', 'SREPhraseStart',
    'SPAS_PAUSE', 'SITooSlow', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SpeechTokenKeyUI', 'SAFT44kHz16BitMono', 'SpSharedRecognizer',
    'STCInprocHandler', 'DISPID_SLAddPronunciation',
    'ISpeechPhraseRules', 'SBONone', 'DISPID_SRRAlternates',
    'DISPID_SRCEPropertyNumberChange', 'SPEI_REQUEST_UI',
    'SpObjectToken', 'SPRS_ACTIVE', 'SVP_13', 'SpResourceManager',
    'SPEI_TTS_BOOKMARK', 'SPFILEMODE', 'SPAUDIOOPTIONS',
    'SPLO_DYNAMIC', 'SpeechRunState', 'SP_VISEME_13',
    'DISPID_SPIGetText', 'SpeechDisplayAttributes',
    'DISPID_SABIBufferSize', 'SpeechRecognizerState',
    '__MIDL_IWinTypes_0009', 'DISPID_SOTCSetId',
    ...
    'SpPhoneConverter', 'SDA_Two_Trailing_Spaces',
    'DISPID_SPCPhoneToId', 'DISPID_SRCRequestedUIType',
    'DISPID_SRRecognizer', 'DISPID_SVSpeak', 'SDTAudio',
    'SVEStartInputStream', 'DISPID_SVSInputSentencePosition',
    'eLEXTYPE_PRIVATE3', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRCEBookmark', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SRCEPropertyStringChange', 'STCRemoteServer',
    'Speech_Max_Word_Length', 'SpeechAddRemoveWord',
    'DISPID_SPEAudioSizeTime', 'SRAORetainAudio',
    'SpeechEngineConfidence', 'Speech_Max_Pron_Length',
    'DISPID_SASCurrentSeekPosition', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SPAs_NewEnum', 'SVSFNLPSpeakPunc', 'DISPID_SVSPhonemeId',
    'ISpeechVoiceStatus', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SVPriority',
    'eLEXTYPE_PRIVATE19', 'SLTApp', 'SPADAPTATIONRELEVANCE',
    'DISPID_SRRRecoContext', 'DISPID_SOTId', 'ISpPhrase',
    'SPWF_SRENGINE', 'DISPIDSPTSI',
    'SpeechPropertyComplexResponseSpeed', 'ISpeechPhraseElements',
    'SVP_9', 'ISpeechDataKey', 'DISPID_SPPValue',
    'eLEXTYPE_PRIVATE17', 'SASRun', 'ISpXMLRecoResult',
    'SAFT48kHz16BitStereo', 'ISpeechGrammarRule',
    'SWPKnownWordPronounceable', 'DISPID_SPIEnginePrivateData',
    'SPPROPERTYINFO', 'DISPID_SPRuleChildren', 'SPRST_ACTIVE_ALWAYS',
    'SASClosed', 'DISPID_SVGetProfiles', 'DISPID_SWFEChannels',
    'SPXMLRESULTOPTIONS', 'ISpeechRecognizer',
    'DISPID_SDKSetBinaryValue', 'SDA_One_Trailing_Space', 'SVP_2',
    'SpeechAudioVolume', 'ISpeechPhraseAlternates',
    'DISPID_SVEViseme', 'DISPID_SpeechLexiconProns',
    'DISPID_SpeechPhraseInfo', 'DISPID_SpeechXMLRecoResult',
    'SP_VISEME_8', 'ISpeechLexiconWords', 'eLEXTYPE_RESERVED4',
    'DISPID_SOTSetId', 'DISPID_SGRAttributes', 'SAFT11kHz16BitMono',
    'DISPID_SGRSAddSpecialTransition', 'SpeechInterference',
    'ISpShortcut', 'DISPID_SVESentenceBoundary',
    'ISpeechAudioBufferInfo', 'DISPID_SMSAMMHandle',
    'SPEI_INTERFERENCE', 'DISPID_SpeechFileStream', 'DISPID_SOTsItem',
    'SpeechVisemeFeature', 'DISPID_SMSADeviceId',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SRCEInterference', 'SPVISEMES',
    'DISPID_SBSSeek', 'SpeechTokenKeyAttributes', 'SP_VISEME_6',
    'SPRECOGNIZERSTATUS', 'SDKLCurrentUser', 'SP_VISEME_9',
    ...
    'ISpProperties', 'SpeechCategoryAudioIn', 'DISPID_SRGId',
    'ISpSerializeState', 'DISPID_SVSCurrentStreamNumber',
    'SPBOOKMARKOPTIONS', 'SVEBookmark', 'DISPID_SOTCGetDataKey',
    'SpShortcut', 'SAFT8kHz16BitMono', 'DISPID_SPAsCount',
    'DISPID_SRRTimes', 'SpNotifyTranslator', 'SPEI_SOUND_END',
    'SREHypothesis', 'SPXRO_Alternates_SML', 'SAFT48kHz8BitStereo',
    'SPEI_START_SR_STREAM', 'SpeechPropertyNormalConfidenceThreshold',
    'SPSVerb', 'DISPID_SPEAudioTimeOffset', 'SRESoundStart',
    'SAFTGSM610_44kHzMono', 'DISPID_SRGCommit', 'SAFT44kHz8BitStereo',
    'ISpMMSysAudio', 'SpeechBookmarkOptions',
    'DISPID_SPAStartElementInResult', 'ISpStream', 'SPCATEGORYTYPE',
    'DISPID_SpeechGrammarRule', 'SPEI_MIN_TTS', 'DISPID_SVEBookmark',
    'ISpeechRecoContext', 'eLEXTYPE_RESERVED10',
    'DISPID_SPARecoResult', 'SpeechTokenContext',
    'DISPID_SVAlertBoundary', 'DISPID_SLPType',
    'SGLexicalNoSpecialChars', 'SDTAll', 'WAVEFORMATEX',
    'DISPID_SASetState', 'SAFTDefault', 'SITooQuiet',
    'DISPID_SASCurrentDevicePosition', 'SPRECORESULTTIMES',
    'SPBO_TIME_UNITS', 'SPAUDIOSTATUS', 'DISPID_SGRSTsCount',
    'ISpeechLexiconPronunciations', 'SAFTCCITT_uLaw_44kHzMono',
    'eLEXTYPE_PRIVATE4', 'DISPID_SVGetAudioInputs',
    'eLEXTYPE_RESERVED8', 'SWPUnknownWordUnpronounceable',
    'eLEXTYPE_VENDORLEXICON', 'SPCONTEXTSTATE',
    'DISPID_SWFEExtraData', 'SPCS_DISABLED', 'DISPID_SRCERecognition',
    'SpFileStream', 'DISPID_SOTRemove', 'DISPID_SPRText',
    'ISpeechPhraseInfoBuilder', 'SPSFunction', 'eWORDTYPE_ADDED',
    ...
    'SpAudioFormat', 'SITooFast', 'DISPID_SVSLastBookmarkId',
    'DISPID_SPRuleId', 'DISPID_SOTGetStorageFileName',
    'SREStreamStart', 'ISpPhoneticAlphabetConverter',
    'SRTExtendableParse', 'SECFDefault', 'SPEI_MAX_TTS',
    'SpeechRecognitionType', 'ISpRecognizer2', 'SPPHRASEPROPERTY',
    'DISPID_SAVolume', 'SP_VISEME_0', 'DISPID_SVAudioOutputStream',
    'ISpeechWaveFormatEx', 'SAFTCCITT_ALaw_8kHzMono', 'SWTDeleted',
    'DISPID_SRIsUISupported', 'SVSFVoiceMask', 'SSTTDictation',
    'SPFM_CREATE_ALWAYS', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SPRsCount', 'SPSTREAMFORMATTYPE', 'eLEXTYPE_PRIVATE2',
    'SRESoundEnd', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'ISpeechResourceLoader', 'SPEI_HYPOTHESIS',
    'DISPID_SDKGetlongValue', 'DISPID_SPAPhraseInfo', 'SpStream',
    'DISPID_SAFType', 'SPWORDPRONUNCIATION',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SECLowConfidence',
    'SPRS_INACTIVE', 'SRCS_Disabled', 'DISPID_SRGSetTextSelection',
    'SREPrivate', 'SP_VISEME_7', 'DISPID_SDKGetStringValue',
    'eLEXTYPE_USER_SHORTCUT', 'SREPropertyStringChange',
    'SpeechRegistryUserRoot', 'Speech_Default_Weight',
    'DISPID_SVGetVoices', 'ISpeechObjectTokens', 'SPSUnknown',
    'SPPS_RESERVED1', 'SREFalseRecognition',
    'SpeechRegistryLocalMachineRoot', 'SPSHT_Unknown', 'SPGS_ENABLED',
    'DISPID_SWFESamplesPerSec', 'ISpeechGrammarRuleState',
    'SpeechGrammarWordType', 'DISPID_SASFreeBufferSpace',
    'eLEXTYPE_LETTERTOSOUND', 'SVSFParseSsml', 'SPRST_INACTIVE',
    'SpUnCompressedLexicon', 'SAFTCCITT_uLaw_11kHzMono',
    'SpeechTokenValueCLSID', 'DISPID_SASNonBlockingIO',
    'SVSFPersistXML', 'eLEXTYPE_PRIVATE5', 'SREAudioLevel',
    'DISPID_SPEs_NewEnum', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SpStreamFormatConverter', 'DISPID_SGRId', 'SVSFNLPMask',
    'DISPID_SPPs_NewEnum', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SPEActualConfidence', 'SPEI_START_INPUT_STREAM',
    'DISPID_SPEsItem', 'SPFM_CREATE', 'SVP_0', 'SRATopLevel',
    'SPVPRI_NORMAL', 'SPWT_PRONUNCIATION',
    'DISPID_SPEDisplayAttributes', 'SpeechPropertyResourceUsage',
    'DISPID_SGRSTNextState', 'SREStateChange', 'SpeechCategoryVoices',
    'DISPID_SGRSTPropertyId', 'eLEXTYPE_PRIVATE13',
    'DISPID_SpeechPhraseRules', 'SREStreamEnd',
    'DISPID_SpeechPhraseReplacements', 'SPWAVEFORMATTYPE',
    'eLEXTYPE_RESERVED9', 'SpeechLexiconType',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SVEPhoneme',
    'ISpRecoCategory', 'SAFTADPCM_11kHzMono', 'SAFT24kHz8BitMono',
    'DISPID_SGRsAdd', 'DISPID_SRGetRecognizers',
    'DISPID_SpeechMMSysAudio', 'DISPID_SMSSetData',
    'SAFT48kHz16BitMono', 'SAFTGSM610_22kHzMono',
    'eLEXTYPE_PRIVATE15', 'SSFMOpenReadWrite',
    'DISPID_SRGDictationSetState', 'ISpObjectWithToken',
    'SPFM_NUM_MODES', 'STCInprocServer', 'DISPID_SPCLangId',
    'SAFTNonStandardFormat', 'SGRSTTWildcard', 'DISPID_SRRPhraseInfo',
    'DISPID_SRCEStartStream', 'SPEVENTSOURCEINFO', 'DISPID_SGRClear',
    'DISPID_SpeechMemoryStream', 'ISpRecoResult',
    'SpeechStreamSeekPositionType', 'SRSEDone',
    'SAFTADPCM_8kHzStereo', 'SPEI_RESERVED5',
    'DISPID_SRCCreateGrammar', 'SPVOICESTATUS', 'SDTReplacement',
    'DISPID_SVEventInterests', 'DISPID_SRRAudio', 'SVP_4',
    ...
    'SpeechPropertyLowConfidenceThreshold', 'SpObjectTokenCategory',
    'DISPID_SPRNumberOfElements', 'DISPID_SAFGuid', 'SP_VISEME_10',
    'SAFTCCITT_ALaw_22kHzMono', 'SAFT32kHz8BitMono',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPEI_END_SR_STREAM',
    'DISPID_SPILanguageId', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SRSActive', 'DISPID_SPRuleFirstElement',
    'DISPID_SPEPronunciation', 'SP_VISEME_4', 'DISPID_SRGetFormat',
    'SAFT11kHz8BitMono', 'SPVPRIORITY', 'SAFTCCITT_uLaw_22kHzStereo',
    'SVEPrivate', 'DISPID_SOTCId', 'STSF_FlagCreate',
    'SpeechRecoEvents', 'DISPID_SPACommit', 'DISPID_SPIStartTime',
    'DISPID_SRCBookmark', 'DISPID_SLWType',
    'DISPID_SGRSAddWordTransition', 'ISpeechPhraseProperty',
    'SPPS_Verb', 'DISPID_SDKSetLongValue', 'eLEXTYPE_PRIVATE7',
    'DISPID_SRCEEndStream', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SASState', 'SPPHRASEELEMENT', 'SVSFUnusedFlags',
    'SP_VISEME_3', 'SPSHT_EMAIL', 'DISPID_SpeechVoiceEvent',
    'DISPID_SpeechObjectTokens', 'SWPUnknownWordPronounceable',
    'SVF_None', 'DISPID_SRRSetTextFeedback', 'SPAR_High',
    'DISPID_SLPPartOfSpeech', 'DISPID_SVVoice', 'SPRULESTATE',
    'DISPID_SPPNumberOfElements', 'DISPID_SOTCreateInstance',
    'SPEVENTENUM', 'SPLOADOPTIONS', 'SVSFlagsAsync',
    'DISPID_SRGIsPronounceable', 'SVSFParseAutodetect',
    'SAFT16kHz16BitMono', 'SPPHRASERULE', 'DISPID_SOTsCount',
    'DISPID_SRGRecoContext', 'SECFIgnoreCase', 'DISPID_SGRsFindRule',
    'DISPID_SRRSpeakAudio', 'eLEXTYPE_PRIVATE20',
    'DISPID_SDKSetStringValue', 'DISPID_SpeechGrammarRules',
    'ISpeechGrammarRuleStateTransitions', 'SAFT8kHz8BitStereo',
    'SVP_20', 'ISpeechRecoGrammar', 'DISPID_SWFEBitsPerSample',
    'DISPID_SOTs_NewEnum', 'SAFT22kHz8BitStereo', 'DISPID_SBSWrite',
    'SPRST_NUM_STATES', 'ISpeechGrammarRuleStateTransition',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SLWPronunciations', 'DISPID_SRCEEnginePrivate',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SpeechObjectToken',
    'DISPID_SpeechRecognizerStatus', 'SAFT22kHz8BitMono',
    'DISPID_SRRAudioFormat', 'SPFM_OPEN_READWRITE',
    'DISPID_SpeechRecoContext', 'SPEI_RECOGNITION',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SVSpeakStream', 'SFTSREngine', 'ISpRecognizer3',
    'ISpeechPhraseProperties', 'SVP_18',
    'SpeechPropertyHighConfidenceThreshold', 'SPPS_RESERVED2',
    'SVSFPurgeBeforeSpeak', 'DISPID_SRSCurrentStreamNumber',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SAStatus',
    'SAFTGSM610_8kHzMono', 'SVP_21', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SVSyncronousSpeakTimeout', 'SVP_14', 'SPCT_SLEEP',
    'DISPID_SVSVisemeId', 'SVESentenceBoundary', 'DISPID_SPIEngineId',
    'SpeechVoiceCategoryTTSRate',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SPRDisplayAttributes', 'DISPID_SLGetPronunciations',
    'SDTProperty', 'SDTRule', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SAFTADPCM_44kHzStereo', 'SGRSTTEpsilon', 'SVP_6',
    'SAFT11kHz16BitStereo', 'SpeechGrammarState', 'SRAExport',
    'DISPID_SRCRetainedAudio', 'DISPID_SRRSaveToMemory',
    'DISPID_SpeechVoiceStatus', 'DISPID_SREmulateRecognition',
    'DISPID_SRGetPropertyString', 'DISPID_SRCERequestUI',
    ...
    'ISpNotifySink', 'SPCS_ENABLED', 'eLEXTYPE_PRIVATE14',
    'ISpNotifyTranslator', 'SpeechAudioState', 'DISPID_SGRs_NewEnum',
    'SAFT11kHz8BitStereo', 'DISPID_SPRFirstElement',
    'DISPID_SpeechPhraseElement', 'ISpeechBaseStream',
    'SDA_Consume_Leading_Spaces', 'ISpNotifySource',
    'SAFTCCITT_uLaw_22kHzMono', 'tagSPPROPERTYINFO',
    'SPSERIALIZEDPHRASE', 'SpeechAudioFormatType', 'SPRULE',
    'SAFT24kHz16BitStereo', 'SP_VISEME_18', 'SPPS_Interjection',
    'DISPID_SVDisplayUI', 'SDKLLocalMachine',
    'DISPID_SLRemovePronunciation', 'DISPID_SLWsCount',
    'DISPID_SPPsItem', 'DISPID_SpeechRecoResult2', 'SPPHRASE',
    'SAFT24kHz16BitMono', 'DISPID_SRCCreateResultFromMemory',
    'SPEI_UNDEFINED', 'DISPID_SRState', 'eLEXTYPE_PRIVATE12',
    'DISPID_SRCEPhraseStart', 'DISPID_SOTIsUISupported',
    'SPCT_DICTATION', 'SpeechDataKeyLocation',
    'SPINTERFERENCE_NOSIGNAL', 'IInternetSecurityManager', 'SPAS_RUN',
    'SSSPTRelativeToCurrentPosition', 'SAFT24kHz8BitStereo',
    'DISPID_SLPsCount', 'DISPID_SpeechRecoContextEvents',
    'SVSFParseMask', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SPISaveToMemory', 'SpeechVoiceSkipTypeSentence',
    'ISpeechLexiconPronunciation', 'SDTAlternates',
    'DISPID_SpeechRecoResult', 'IStream', 'SVP_19',
    'ISpeechPhraseAlternate', 'SpeechCategoryAudioOut',
    'SVSFIsFilename', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SVSpeakCompleteEvent', 'SRTAutopause',
    'DISPID_SRAudioInputStream', 'DISPID_SpeechGrammarRuleState',
    'SPRECOSTATE', 'LONG_PTR', 'SPSModifier', 'DISPID_SRProfile',
    'DISPID_SRCCmdMaxAlternates', 'SVSFDefault', 'SPCT_COMMAND',
    'SPINTERFERENCE_NOISE', 'DISPID_SPPEngineConfidence',
    'SPSEMANTICFORMAT', 'SPCT_SUB_DICTATION', 'SPWF_INPUT',
    'SPAR_Unknown', 'DISPID_SVIsUISupported', 'SVSFParseSapi',
    'SREAllEvents', 'SRTStandard', 'DISPID_SPRulesItem',
    'eLEXTYPE_PRIVATE6', 'SECFIgnoreWidth', 'ISpLexicon',
    'SPINTERFERENCE_TOOSLOW', 'SPSERIALIZEDRESULT', 'SPPS_Noncontent',
    'SPRECOCONTEXTSTATUS', 'SpMMAudioIn', 'DISPID_SRDisplayUI',
    'DISPID_SpeechBaseStream', 'DISPID_SLPSymbolic',
    'DISPID_SWFEBlockAlign', 'DISPID_SLPPhoneIds',
    'DISPID_SpeechPhraseElements', 'SPSNotOverriden',
    'ISpPhoneticAlphabetSelection', 'DISPID_SOTRemoveStorageFileName',
    'ISequentialStream', 'SPAO_NONE', 'SECNormalConfidence',
    'SPSEMANTICERRORINFO', 'DISPID_SLWLangId', 'DISPID_SLPs_NewEnum',
    'ISpResourceManager', 'DISPID_SAFSetWaveFormatEx',
    'SPEI_ADAPTATION', 'DISPID_SLPLangId',
    'SpeechCategoryPhoneConverters', 'SPXRO_SML',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPCT_SUB_COMMAND',
    'DISPID_SDKEnumKeys', 'tagSTATSTG'
]

_check_version('1.2.0', 1658701842.566086)
